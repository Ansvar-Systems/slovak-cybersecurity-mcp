# ─────────────────────────────────────────────────────────────────────────────
# Slovak Cybersecurity (CSIRT.SK) MCP — multi-stage Dockerfile
# ─────────────────────────────────────────────────────────────────────────────
# Build:  docker build -t slovak-cybersecurity-mcp .
# Run:    docker run --rm -p 3000:3000 slovak-cybersecurity-mcp
#
# The image bakes /app/data/sk-cert.db at build time. Override
# SK_CERT_DB_PATH for a custom location at runtime.
# ─────────────────────────────────────────────────────────────────────────────
...
ENV SK_CERT_DB_PATH=/app/data/sk-cert.db
...
# Bake the pre-built database into the image so /app/data/sk-cert.db
